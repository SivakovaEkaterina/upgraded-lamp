namespace _03_Battleship.Model
{
    ...
    public class Client
    {
        ...
        {
            this.connection = connection ?? throw new ArgumentNullException("Значение не должно быть равно нулю");
        ...
        public void Connect()
        {
            ...
            {
                throw new ArgumentNullException(nameof(this.ServerIP), "Значение не должно быть равно нулю");
            }
