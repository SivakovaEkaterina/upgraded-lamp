namespace _03_Battleship.Model
{
    ...
    public class Server
    {
        ...
        {
            this.connectionManager = connectionManager ?? throw new ArgumentNullException(nameof(connectionManager), "Значение не должно быть равно нулю");
        ...
        private void ConnectionManager_ConnectionAccepted(object sender, ClientAcceptedEventArgs args)
        {
            ...
            connectionData.UserName = "Игрок 2";
